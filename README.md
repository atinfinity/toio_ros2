...
|/toio/battery_level|[std_msgs/msg/Float32](https://docs.ros2.org/foxy/api/std_msgs/msg/Float32.html)|battery level of toio in percent. The cube notifies it in discrete steps (10/20/50/100), see the [toio spec](https://toio.github.io/toio-spec/docs/ble_battery)|
